...
public class CallStackAnomalyAnalysis extends TmfStateSystemAnalysisModule {
    ...
    public static final @NonNull String ID = "org.eclipse.tracecompass.lttng2.ust.core.callstackanomaly"; //$NON-NLS-1$
    ...
    protected @NonNull ITmfStateProvider createStateProvider() {
        return new CallStackAnomalyAnalysisProvider(checkNotNull(getTrace()), fParameters, fMonitor);
    }
