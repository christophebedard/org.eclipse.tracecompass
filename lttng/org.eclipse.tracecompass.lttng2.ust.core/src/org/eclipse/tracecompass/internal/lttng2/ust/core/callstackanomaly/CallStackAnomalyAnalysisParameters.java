...
public class CallStackAnomalyAnalysisParameters {
    ...
    private final @Nullable String fModelFilePath;
    /** The learning rate */
    ...
    public CallStackAnomalyAnalysisParameters(
        ...
        this(false, type, targetDepth, nValue, modelFilePath, learningRate, numEpochs, batchSize, anomalyThreshold);
    }
