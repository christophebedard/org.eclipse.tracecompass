 ...
 * <p>
 * This uses {@link CallStackArrays} to read arrays from the supplementary file.
 *
...
public class CallStackDataSetIterator implements DataSetIterator {
     ...
     *            the batch size
     */
    public CallStackDataSetIterator(CallStackArrays arrays, int batchSize) {
        fArrays = arrays;
        ...
        try {
            ...
            for (int i = 0; i < batchSize; ++i) {
                if (hasNext()) {
                    ...
                    INDArray concatFlat = Nd4j.concat(0, callstackArray.getOffsetArray(), callstackArray.getSelftimeArray()).linearView();
